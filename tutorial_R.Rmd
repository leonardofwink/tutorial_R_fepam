...
```{r Gráfico OD, fig.cap="Oxigênio Dissolvido", message=FALSE, warning=FALSE}
...
```{r Gráfico DBO, warning = FALSE, message = FALSE, fig.cap="Demanda Bioquímica de Oxigênio"}
...
```{r Gráfico Ecoli, warning = FALSE, message = FALSE, fig.cap="Escherichia-coli"}
...
```{r Gráfico fósforo total, warning = FALSE, message = FALSE, fig.cap="Fósforo total"}
...
```{r Gráfico Nitrogênio Amoniacal, warning = FALSE, message = FALSE, fig.cap="Nitrogênio Amoniacal"}
...
```{r Gráfico Turbidez, fig.cap="turbidez", warning = FALSE, message = FALSE}
...
```{r Gráfico pH, fig.cap="pH-gravataí no período 1990-2020", warning = FALSE, message = FALSE}
...
```{r Gráfico SólTot, fig.cap="sólidos-totais", warning = FALSE, message = FALSE}
...
```{r Gráfico cond_elet, fig.cap="condutividade-eletrica", warning = FALSE, message = FALSE}
...
```{r gráfico ao longo do tempo, warning = FALSE, message = FALSE}
ano_inicial <- 2015
ano_final <- 2022
...
```{r Correlação, fig.cap="correlação-parametros-qualidade-agua", time_it = TRUE, warning=FALSE, message = FALSE,}
...
RS <- subset(Brasil, NAME_1 == "Rio Grande do Sul") 
...
```{r Extraindo os dados raster de precipitação, message = FALSE, warning = FALSE, include = FALSE}
st_centroid(RS)
...
```{r Elaborando os meses de precipitação, message = FALSE, warning = FALSE, include = FALSE}
...
```{r mapas-precipitacao-mensal, include = FALSE}
